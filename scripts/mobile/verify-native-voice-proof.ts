...
type Metrics = { assistantTranscriptTurns?: number; bytesReceived?: number; bytesSent?: number; dataChannelOpen?: boolean; microphonePermissionGranted?: boolean; peerConnected?: boolean; remoteAudioTrackReceived?: boolean; sessionId?: string; userTranscriptTurns?: number; verificationPhrase?: string };
