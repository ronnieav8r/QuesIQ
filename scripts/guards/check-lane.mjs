...
const lanes = {
  ...
  interview: [
    ...
    "drizzle/0078_turn_based_progression_cleanup.sql",
    ...
    "src/app/api/admin/progression/route.ts",
...
function usage() {
  console.error(
    "Usage: node scripts/guards/check-lane.mjs <admin|interview|study|dpe|nclex|quira> [target-ref] [base-ref]",
  );
