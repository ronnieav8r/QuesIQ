...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (certificateOptions.some((certificateType) => certificateType.id === certificateTypeId)) return;

    setCertificateTypeId(certificateOptions[0].id);
  }, [certificateOptions, certificateTypeId]);
