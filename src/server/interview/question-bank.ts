...
function toQuestionRecord(row: typeof interviewQuestions.$inferSelect): InterviewQuestionRecord {
  return {
    ...
    questionAudioModel: row.questionAudioModel ?? undefined,
    questionAudioTextHash: row.questionAudioTextHash ?? undefined,
    questionAudioUrl: row.questionAudioUrl ?? undefined,
    questionAudioVoice: row.questionAudioVoice ?? undefined,
