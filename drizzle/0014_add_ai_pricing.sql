...
INSERT INTO "ai_pricing" ("model", "modality", "input_micro_usd_per_million", "cached_input_micro_usd_per_million", "output_micro_usd_per_million", "source_url", "version") VALUES
	('gpt-5.4-mini', 'text', 250000, null, 2000000, 'https://openai.com/api/pricing/', 'quesiq-seed-2026-05-24-v1'),
	('gpt-realtime', 'audio', 32000000, 400000, 64000000, 'https://openai.com/api/pricing/', 'quesiq-seed-2026-05-24-v1'),
	('gpt-realtime-1.5', 'audio', 32000000, 400000, 64000000, 'https://openai.com/api/pricing/', 'quesiq-seed-2026-05-24-v1'),
	('gpt-realtime-2', 'audio', 32000000, 400000, 64000000, 'https://openai.com/api/pricing/', 'quesiq-seed-2026-05-24-v1'),
	('gpt-realtime-mini', 'audio', 10000000, 300000, 20000000, 'https://openai.com/api/pricing/', 'quesiq-seed-2026-05-24-v1');
