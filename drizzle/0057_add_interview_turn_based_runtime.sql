...
VALUES
  ...
  ('rapid_fire', null, 'Vague answer recovery', 'clarity under follow-up', 'standard', 'Follow up when prior answers lacked proof or impact.', 'Ask one short recovery-style follow-up that makes the candidate add evidence, impact, or personal ownership.', '["What specifically did you do?", "What changed because of your action?"]'::jsonb, '["Look for sharper ownership.", "Reward concise correction under pressure."]'::jsonb, 50)
